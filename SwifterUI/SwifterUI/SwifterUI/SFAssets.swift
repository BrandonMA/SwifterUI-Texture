...
//  SwifterUI
//
//  Created by Brandon Maldonado on 27/08/17.
...
public class SFAssets : NSObject {
    ...
    private struct Cache {
        ...
        static var imageOfCloseIconDark: UIImage?
        static var closeIconDarkTargets: [AnyObject]?
        static var imageOfCloseIconLight: UIImage?
        static var closeIconLightTargets: [AnyObject]?
    }
    ...
    @objc dynamic public class func drawCloseIconDark(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 10, height: 10), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        bezier2Path.close()
        bezier2Path.usesEvenOddFillRule = true
        SFAssets.alternativeBlack.setFill()
        bezier2Path.fill()
    ...
    @objc dynamic public class func drawCloseIconLight(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 10, height: 10), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let picturePath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 12, height: 12))
        SFAssets.whiteTextField.setFill()
        picturePath.fill()
    ...
    @objc dynamic public class var imageOfCloseIconDark: UIImage {
        if Cache.imageOfCloseIconDark != nil {
            return Cache.imageOfCloseIconDark!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 10, height: 10), false, 0)
            SFAssets.drawCloseIconDark()

        Cache.imageOfCloseIconDark = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return Cache.imageOfCloseIconDark!
    }

    @objc dynamic public class var imageOfCloseIconLight: UIImage {
        if Cache.imageOfCloseIconLight != nil {
            return Cache.imageOfCloseIconLight!
        }

        UIGraphicsBeginImageContextWithOptions(CGSize(width: 10, height: 10), false, 0)
            SFAssets.drawCloseIconLight()

        Cache.imageOfCloseIconLight = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()
    ...
    @objc @IBOutlet dynamic var closeIconDarkTargets: [AnyObject]! {
        get { return Cache.closeIconDarkTargets }
        set {
            Cache.closeIconDarkTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: SFAssets.imageOfCloseIconDark)
            }
        }
    }

    @objc @IBOutlet dynamic var closeIconLightTargets: [AnyObject]! {
        get { return Cache.closeIconLightTargets }
        set {
            Cache.closeIconLightTargets = newValue
            for target: AnyObject in newValue {
                let _ = target.perform(NSSelectorFromString("setImage:"), with: SFAssets.imageOfCloseIconLight)
            }
        }
    }
