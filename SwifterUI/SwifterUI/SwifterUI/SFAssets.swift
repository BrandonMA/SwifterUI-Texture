...
//  SwifterUI
//
//  Created by Brandon Maldonado on 17/12/17.
...
public class SFAssets : NSObject {
    ...
    @objc dynamic public class func drawArrowDown(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 20, height: 16), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 20, height: 16), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 20, y: resizedFrame.height / 16)


        //// Color Declarations
        let fillColor12 = UIColor(red: 0.592, green: 0.592, blue: 0.592, alpha: 1.000)

        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 10, y: 13.59))
        bezierPath.addLine(to: CGPoint(x: 1.71, y: 5.29))
        bezierPath.addCurve(to: CGPoint(x: 0.29, y: 5.29), controlPoint1: CGPoint(x: 1.32, y: 4.9), controlPoint2: CGPoint(x: 0.68, y: 4.9))
        bezierPath.addCurve(to: CGPoint(x: 0.29, y: 6.71), controlPoint1: CGPoint(x: -0.1, y: 5.68), controlPoint2: CGPoint(x: -0.1, y: 6.32))
        bezierPath.addLine(to: CGPoint(x: 9.29, y: 15.71))
        bezierPath.addCurve(to: CGPoint(x: 10.71, y: 15.71), controlPoint1: CGPoint(x: 9.68, y: 16.1), controlPoint2: CGPoint(x: 10.32, y: 16.1))
        bezierPath.addLine(to: CGPoint(x: 19.71, y: 6.71))
        bezierPath.addCurve(to: CGPoint(x: 19.71, y: 5.29), controlPoint1: CGPoint(x: 20.1, y: 6.32), controlPoint2: CGPoint(x: 20.1, y: 5.68))
        bezierPath.addCurve(to: CGPoint(x: 18.29, y: 5.29), controlPoint1: CGPoint(x: 19.32, y: 4.9), controlPoint2: CGPoint(x: 18.68, y: 4.9))
        bezierPath.addLine(to: CGPoint(x: 10, y: 13.59))
        bezierPath.close()
        fillColor12.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawShareIcon(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 13.9, y: 6.46))
        bezierPath.addLine(to: CGPoint(x: 21.5, y: 6.46))
        bezierPath.addLine(to: CGPoint(x: 21.5, y: 24))
        bezierPath.addLine(to: CGPoint(x: 2.5, y: 24))
        bezierPath.addLine(to: CGPoint(x: 2.5, y: 6.46))
        bezierPath.addLine(to: CGPoint(x: 10.1, y: 6.46))
        bezierPath.addLine(to: CGPoint(x: 10.1, y: 7.38))
        bezierPath.addLine(to: CGPoint(x: 3.45, y: 7.38))
        bezierPath.addLine(to: CGPoint(x: 3.45, y: 23.08))
        bezierPath.addLine(to: CGPoint(x: 20.55, y: 23.08))
        bezierPath.addLine(to: CGPoint(x: 20.55, y: 7.38))
        bezierPath.addLine(to: CGPoint(x: 13.9, y: 7.38))
        bezierPath.addLine(to: CGPoint(x: 13.9, y: 6.46))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 8.27, y: 4.97))
        bezierPath.addLine(to: CGPoint(x: 7.58, y: 4.3))
        bezierPath.addLine(to: CGPoint(x: 12, y: 0))
        bezierPath.addLine(to: CGPoint(x: 16.42, y: 4.3))
        bezierPath.addLine(to: CGPoint(x: 15.73, y: 4.97))
        bezierPath.addLine(to: CGPoint(x: 12.49, y: 1.81))
        bezierPath.addLine(to: CGPoint(x: 12.49, y: 15.83))
        bezierPath.addLine(to: CGPoint(x: 11.51, y: 15.83))
        bezierPath.addLine(to: CGPoint(x: 11.51, y: 1.81))
        bezierPath.addLine(to: CGPoint(x: 8.27, y: 4.97))
        bezierPath.close()
        bezierPath.usesEvenOddFillRule = true
        SFAssets.gray.setFill()
        bezierPath.fill()
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 20, height: 11), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
